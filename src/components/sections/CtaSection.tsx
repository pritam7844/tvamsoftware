    ...
    <section className="bg-white py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative rounded-3xl border border-slate-200 bg-[#F8FAFC] overflow-hidden shadow-sm">
          ...
          {/* Top accent strip */}
          <div className="h-1.5 w-full bg-gradient-to-r from-[#006837] via-[#EAA812] to-[#006837]" />
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <svg viewBox="0 0 900 340" className="absolute right-0 top-0 h-full opacity-[0.04]" preserveAspectRatio="xMaxYMid slice" aria-hidden="true">
              <circle cx="750" cy="80"  r="180" stroke="#006837" strokeWidth="1.5" fill="none" />
              <circle cx="750" cy="80"  r="130" stroke="#006837" strokeWidth="1" fill="none" />
              <circle cx="750" cy="80"  r="80"  stroke="#006837" strokeWidth="1" fill="none" />
              <circle cx="820" cy="280" r="120" stroke="#006837" strokeWidth="1.5" fill="none" />
              <circle cx="120" cy="300" r="90"  stroke="#006837" strokeWidth="1" fill="none" />
            </svg>
          </div>

          <div className="relative px-8 py-16 lg:px-20 lg:py-20">
            <div className="max-w-2xl mx-auto text-center">
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#006837] mb-5">Let&apos;s talk</p>

              <h2 className="text-4xl sm:text-5xl font-black text-[#0F172A] leading-tight">
                Your idea deserves<br />
                <span className="text-[#006837]">a great team.</span>
              </h2>
              ...
              <div className="mt-10 flex flex-wrap justify-center gap-4">
                ...
                <a href="tel:+918898489138"
                  className="inline-flex items-center gap-2.5 px-8 py-4 border border-slate-200 text-slate-700 font-semibold rounded-full text-sm hover:border-[#006837] hover:text-[#006837] hover:bg-[#006837]/5 transition-colors">
              ...
              <div className="mt-10 flex flex-wrap justify-center gap-5 text-xs text-slate-500">
                {['Free consultation. No commitment.', 'Reply within 24 hours.', 'NDA available on request.'].map((item) => (
                  <span key={item} className="flex items-center gap-1.5">
                    <CheckCircle size={13} className="text-[#006837]" />
                    {item}
                  </span>
                ))}
              </div>
