          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            {status === 'sent' ? (
              <div className="p-10 text-center">
                <div className="w-16 h-16 rounded-full bg-[#006837]/10 flex items-center justify-center mx-auto mb-4">
                ...
                <button onClick={closeModal} className="mt-6 px-6 py-3 bg-[#006837] text-white rounded-full font-semibold text-sm hover:bg-[#004D28] transition-colors">
                  Close
                </button>
              </div>
            ) : (
